...
from transformers import AutoTokenizer, TFAutoModelForQuestionAnswering, AutoConfig, TFDistilBertForQuestionAnswering
...
# config = AutoConfig.from_pretrained('test-covid-trained/config.json')
