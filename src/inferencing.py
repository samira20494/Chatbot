...
tokenizer = AutoTokenizer.from_pretrained('test-covid-trained/')
model = AutoModelForQuestionAnswering.from_pretrained('test-covid-trained/')
...
output = model(inputs) # model(torch.tensor([input_ids]))
